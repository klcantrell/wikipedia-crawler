...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__controller__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__view__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__css_main_css__ = __webpack_require__(32);
...
var model = Object(__WEBPACK_IMPORTED_MODULE_0__model__["a" /* default */])(),
    controller = Object(__WEBPACK_IMPORTED_MODULE_1__controller__["a" /* default */])(),
    view = Object(__WEBPACK_IMPORTED_MODULE_2__view__["a" /* default */])(controller);
...
function Model() {
  return {
    makeWikipediaRequest: function makeWikipediaRequest(userQuery) {
      var url = 'https://7k1zglj62f.execute-api.us-east-2.amazonaws.com/v0/wikipedia-crawl/' + userQuery;
      var data = void 0;
...
function Controller() {
  ...
  function formatSnippet(searchResultData) {
    var spanTagsRegExp = /<\/*[^>]*>/;
    return searchResultData.snippet.split(spanTagsRegExp).filter(function (item) {
      return item ? !item.match(/^\s$/) : false;
    }).join('').split(' ').slice(0, 12).join(' ').concat('...');
  }

  function formatLink(searchResultData) {
    var linkTag = searchResultData.title.split(' ').join('_');
  ...
  return {
    ...
    executeSearch: function executeSearch(userInput) {
      return new Promise(function (resolve) {
        var query = formatUserSearch(userInput);
        if (query) {
          deps.model.makeWikipediaRequest(query).then(function (results) {
            if (results.length > 0) {
          ...
          deps.view.renderError().then(function () {
            resolve();
          });
        }
      });
    },
    formatSearchResultData: function formatSearchResultData(searchResultData) {
      return {
...
var _templateObject = _taggedTemplateLiteral(['\n      <a href=', '\n         target="_blank"\n         rel="noopener"\n         class="wiki-crawler__result wiki-crawler__result--hidden">\n        <h1 class="wiki-crawler__result-title">', '</h1>\n        <p class="wiki-crawler__result-snippet">', '</p>\n      </a>\n    '], ['\n      <a href=', '\n         target="_blank"\n         rel="noopener"\n         class="wiki-crawler__result wiki-crawler__result--hidden">\n        <h1 class="wiki-crawler__result-title">', '</h1>\n        <p class="wiki-crawler__result-snippet">', '</p>\n      </a>\n    ']),
...
function View(controller) {
  ...
  function whenReturnBtnClicked() {
    destroySearchResults().then(function () {
  ...
  function renderSearchResults(searchResults) {
    ...
    return new Promise(function (resolve) {
      ...
      var _loop = function _loop(searchResult) {
        promiseChain = promiseChain.then(function () {
          return createSearchResultElement(searchResult).then(function (element) {
  ...
  function createSearchResultElement(searchResultData) {
    return new Promise(function (resolve) {
      var itemData = controller.formatSearchResultData(searchResultData),
          content = resultContent(itemData),
          resultElShell = document.createElement('DIV');
      resultElShell.innerHTML = content;
      var resultEl = resultElShell.firstElementChild;
  ...
  function resultContent(searchResultData) {
    return Object(__WEBPACK_IMPORTED_MODULE_0__utils__["a" /* html */])(_templateObject, searchResultData.link, searchResultData.title, searchResultData.snippet);
  }
  ...
  function destroySearchResults() {
    return fadeOutSearchResults().then(function () {
  ...
  function renderError() {
    var p = new Promise(function (resolve) {
      dom.resultsSection.classList.remove('wiki-crawler__results--hidden');
      var noResultsShell = document.createElement('DIV');
      noResultsShell.innerHTML = Object(__WEBPACK_IMPORTED_MODULE_0__utils__["a" /* html */])(_templateObject2);
      var noResultsEl = noResultsShell.firstElementChild;
